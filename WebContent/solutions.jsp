...
<html>
<head>
<title>Solutions - Solutions | Hosting - Free Website Template from Templates.com</title>
					...
					<div class="right">
						<nav>
							<ul>
								...
								<li class="current"><a href="solutions.jsp">Solutions</a></li>
